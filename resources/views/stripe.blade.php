...
<html>
<head>
    <title>Muneeb Saleem - Gaditek</title>
...
<div class="container">
    ...
    <h1 class="text-center" style="margin-top: 50px;">Stripe Payment <br/> Pay for purchase service</h1>
                                ...
                                <select name="name" class="form-control @error('name') is-invalid @enderror">
					              <option label="Choose Service"></option>
					                @foreach($all_services as $all_service )
					                  <option {{ in_array($all_service, $get_actives) ? 'disabled="disabled"' : '' }} value="{{ $all_service }}">{{ $all_service }}</option>
					                @endforeach
					            </select>
					            @error('name')
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                                <label class='control-label'>Name on Card</label> <input
                                    class='form-control' size='4' type='text' placeholder='Muneeb Saleem'>
                            </div>
                        </div>
